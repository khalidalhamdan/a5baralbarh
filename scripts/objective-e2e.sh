...
AUTO_PUBLISH=true AUTO_EXIT=true OUT_FILE="${OUT_FILE}" ADMIN_BASE_URL="$ADMIN_BASE_URL" WORKER_TRIGGER_TOKEN="$WORKER_TRIGGER_TOKEN" DATABASE_URL="$DATABASE_URL" EPISODE_ID="$EPISODE_ID" \
