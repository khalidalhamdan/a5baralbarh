...
const zodJsonSchema={type:"object",additionalProperties:false,required:["title","description","summary","telegramCaption","segments","sourceUrls","estimatedSeconds","disclosure"],properties:{title:{type:"string"},description:{type:"string"},summary:{type:"string"},telegramCaption:{type:"string"},sourceUrls:{type:"array",items:{type:"string"}},estimatedSeconds:{type:"number",minimum:480,maximum:720},disclosure:{type:"string"},segments:{type:"array",items:{type:"object",additionalProperties:false,required:["id","speaker","text","storyId","sourceUrls","pronunciationNotes","estimatedSeconds"],properties:{id:{type:"string"},speaker:{enum:["host_a","host_b"]},text:{type:"string"},storyId:{type:"string"},sourceUrls:{type:"array",items:{type:"string"}},pronunciationNotes:{type:"array",items:{type:"string"}},estimatedSeconds:{type:"number"}}}}}} as const;
